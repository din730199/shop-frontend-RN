...
import { FlatList,
  View, Text, Image, StyleSheet, Dimensions, TouchableOpacity, ScrollView, Alert, PixelRatio
} from 'react-native';
        ...
        <Header title={'DRESS FOR YOU'}/>
                <View style={styles.cardStyle}>
                    ...
                    <View style={styles.imageContainer}>
                        <ScrollView showsHorizontalScrollIndicator={false} style={{ flexDirection: 'row', height: swiperHeight }} horizontal >
                          {
                    ...
                    <View style={styles.footer}>
                        ...
                        <View>
                          <Text style={styles.textBlack}>{product.name.toUpperCase()}</Text>
                          <Text style={styles.textSmoke}>{this.currencyFormat(product.price)}</Text>
                        </View>
                        <TouchableOpacity onPress={()=> this.addCart(product)} style={{flex: 1,alignItems:'flex-end',justifyContent:'flex-end',}}>
                        ...
                        <View style={styles.descContainer}>
                          ...
                          {this.state.showMore && product.description.length > 400 ? (
                            <Text style={styles.descStyle}>{product.description.split('').slice(0, 400)}...</Text>
                          ) : (
